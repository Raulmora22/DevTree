...
export const FaX = ({ size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 20"
...
export const FaTiktok = ({ size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const FaPortfolio = ({ size = 24, className }: IconProps) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M6,16 L16,16 L6,16 L6,16 Z M6,12 L18,12 L6,12 L6,12 Z M6,8 L11,8 L6,8 L6,8 Z M14,1 L14,8 L21,8 M3,23 L3,1 L15,1 L21,7 L21,23 L3,23 Z" />
  </svg>
);
...
export const FaWeb = ({ size = 24 }: IconProps) => (
  <PanelsTopLeft size={size} />
);
